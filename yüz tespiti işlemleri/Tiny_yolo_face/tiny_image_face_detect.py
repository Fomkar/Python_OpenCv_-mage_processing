# -*- coding: utf-8 -*-
"""
Created on Wed Jun  8 16:05:50 2022
...
frame = cv2.imread("1655631996365.jpg")
...
for max_id in max_ids:
   ...
   # print("start x:{}  y : {}  width : {}  high : {}".format(start_x,start_y,box_width,box_height))
    ...
    cv2.putText(frame, label, (start_x, start_y - 10), cv2.FONT_ITALIC, 0.6, box_color, 1)

t, _ = model.getPerfProfile()
text = 'Inference time: %.2f ms' % (t * 1000.0 / cv2.getTickFrequency())
cv2.putText(frame, text, (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 0), 1)
cv2.imshow("Detection",frame)   
cv2.imwrite("images/omer_detect_vga.jpg",frame)
cv2.waitKey(0)
